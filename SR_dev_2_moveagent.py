...
class smooth_movement:
    ...
    def robot(self):
        ...
        if current_state == states[0]:
            ...
            n = 0; m = 0; x = 0; y = 0; a = 10; b = 10

        if states[1] == current_state:
            n = -1; x = 110; m = 1; y = 0; a = 10; b = 10
        ...
        for i in range(1, 6):
            time.sleep(0.5)
            if i == 1:
                self.beam_1 = self.frame.create_polygon(486+n*x, 294+m*y, 494+n*x, 294+m*y, 494+n*x, 296+m*y, 486+n*x,
                                                        296+m*y, 486+n*x, 294+m*y, fill='yellow')
                self.beam_2 = self.frame.create_polygon(515+n*x, 274+m*y, 515+n*x, 266+m*y, 517+n*x, 266+m*y, 517+n*x,
                                                        274+m*y, 514+n*x, 274+m*y, fill='yellow')
                self.beam_3 = self.frame.create_polygon(536+n*x, 294+m*y, 544+n*x, 294+m*y, 544+n*x, 296+m*y, 536+n*x,
                                                        296+m*y, 536+n*x, 294+m*y, fill='yellow')
                self.beam_4 = self.frame.create_polygon(515+n*x, 316+m*y, 515+n*x, 324+m*y, 517+n*x, 324+m*y, 517+n*x,
                                                        316+m*y, 514+n*x, 316+m*y, fill='yellow')
            if i == 2:
                self.beam_5 = self.frame.create_polygon(486-a+n*x, 294+m*y, 494-a+n*x, 294+m*y, 494-a+n*x, 296+m*y,
                                                        486-a+n*x, 296+m*y, 486-a+n*x, 294+m*y, fill='yellow')
                self.beam_6 = self.frame.create_polygon(515+n*x, 274-b+m*y, 515+n*x, 266-b+m*y, 517+n*x, 266-b+m*y,
                                                        517+n*x, 274-b+m*y, 514+n*x, 274-b+m*y, fill='yellow')
                self.beam_7 = self.frame.create_polygon(536+a+n*x, 294+m*y, 544+a+n*x, 294+m*y, 544+a+n*x, 296+m*y,
                                                        536+a+n*x, 296+m*y, 536+a+n*x, 294+m*y, fill='yellow')
                self.beam_8 = self.frame.create_polygon(515+n*x, 316+b+m*y, 515+n*x, 324+b+m*y, 517+n*x, 324+b+m*y,
                                                        517+n*x, 316+b+m*y, 514+n*x, 316+b+m*y, fill='yellow')
            if i == 3:
                self.beam_9 = self.frame.create_polygon(486-2*a+n*x, 294+m*y, 494-2*a+n*x, 294+m*y, 494-2*a+n*x,
                                                296+m*y, 486-2*a+n*x, 296+m*y, 486-2*a+n*x, 294+m*y, fill='yellow')
                self.beam_10 = self.frame.create_polygon(515+n*x, 274-2*b+m*y, 515+n*x, 266-2*b+m*y, 517+n*x,
                                                266-2*b+m*y, 517+n*x, 274-2*b+m*y, 514+n*x,274-2*b+m*y, fill='yellow')
                self.beam_11 = self.frame.create_polygon(536+2*a+n*x, 294+m*y, 544+2*a+n*x, 294+m*y, 544+2*a+n*x,
                                                296+m*y, 536+2*a+n*x, 296+m*y, 536+2*a+n*x, 294+m*y,fill='yellow')
                self.beam_12 = self.frame.create_polygon(515+n*x, 316+2*b+m*y, 515+n*x, 324+2*b+m*y, 517+n*x,
                                                324+2*b+m*y, 517+n*x, 316+2*b+m*y, 514+n*x, 316+2*b+m*y, fill='yellow')
            if i == 4:
                self.beam_13 = self.frame.create_polygon(486-3*a+n*x, 294+m*y, 494-3*a+n*x, 294+m*y, 494-3*a+n*x,
                                                296+m*y, 486-3*a+n*x, 296+m*y, 486-3*a+n*x, 294+m*y, fill='yellow')
                self.beam_14 = self.frame.create_polygon(515+n*x, 274-3*b+m*y, 515+n*x, 266-3*b+m*y, 517+n*x,
                                                266-3*b+m*y, 517+n*x, 274-3*b+m*y, 514+n*x, 274-3*b+m*y, fill='yellow')
                self.beam_15 = self.frame.create_polygon(536+3*a+n*x, 294+m*y, 544+3*a+n*x, 294+m*y, 544+3*a+n*x,
                                                296+m*y, 536+3*a+n*x, 296+m*y, 536+3*a+n*x, 294+m*y, fill='yellow')
                self.beam_16 = self.frame.create_polygon(515+n*x, 316+3*b+m*y, 515+n*x, 324+3*b+m*y, 517+n*x,
                                                324+3*b+m*y, 517+n*x, 316+3*b+m*y, 514+n*x, 316+3*b+m*y, fill='yellow')
            self.frame.update()
        """"add walls and block"""
        if current_state == states[0]:
            self.frame.create_rectangle(350, 130, 570, 240, fill='grey')
    ...
    def move_agent(self):
        ...
        """generic coordinates"""
        coords = [[500, 280], [390, 280], [280, 280], [280, 170], [280, 60], [170, 60],
                  [60, 60]], [390, 60], [500, 60]
        self.start_world()
        current_state = 1
